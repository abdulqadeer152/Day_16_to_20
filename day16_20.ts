...
let Price1:number[]=[1000, 1200, 1400];
let Price2:number[]= [1100,1300, 1500];
...
function logHobbies(...hobies:string[]){
...
function calculateArea(lenght:number, weight:number){
...
function makeAddress(valueToAdd: number): (num: number) => number {
